...
import LedgerWithdrawComponent from './LedgerWithdrawComponent.js';
  ...
  openModal = async () => {
    ...
    render() {
        ...
        <div className="centered padd-25 margin-top-25">
                ...
                <button href="#" className="btn withdrawnowbtn" onClick={() => this.openModal()} > Withdraw rewards with your Ledger</button>
                </div>
            </div>
          )}
          </div>
