    ...
    render() {
        return (
          ...
          {this.state.modalShow ? (
            <LedgerRedelegateComponent style={{padding:'50px'}} validator_addr={this.props.validator_addr} api_url={this.props.api_url} fee={this.props.fee} memo={this.props.memo} chainID={this.props.chainID} validator_name={this.props.validator_name}/>
          ) : (
